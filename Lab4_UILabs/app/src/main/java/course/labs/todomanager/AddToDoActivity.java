	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				setResult(Activity.RESULT_CANCELED, endIntent);
                finish();
			}
		});
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Priority priority = ((RadioButton)findViewById(R.id.lowPriority)).isChecked() ? Priority.LOW : Priority.MED; // default MED
				priority = ((RadioButton)findViewById(R.id.highPriority)).isChecked() ? Priority.HIGH : priority;

				// TODO - Get the current Status
				Status status = ((RadioButton)findViewById(R.id.statusDone)).isChecked() ? Status.DONE : Status.NOTDONE;
