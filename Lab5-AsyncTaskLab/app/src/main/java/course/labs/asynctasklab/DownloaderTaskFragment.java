...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> Friend_IDs = getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);


		// TODO: Start the DownloaderTask
        new DownloaderTask().execute(Friend_IDs.toArray(new Integer[Friend_IDs.size()]));
	}
